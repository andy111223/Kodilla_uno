...
public class ForumTestSuite {
    ...
    class TestPosts {
        ...
        void testAddPost() {
            ...
            //When
            forumUser.addPost("mrsith", "Hello Everyone! This is my first contribution here!");
            //Then
        ...
        void testGetPost() {
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello eveyone, this is my first contribution here", "mrsmith");
